...
def analyze_emotions_video(video_path, output_path, known_face_encodings, known_face_names):
    ...
    for _ in tqdm(range(total_frames), desc="Processando vídeo"):
        ...
        for face in result:
            if face['face_confidence'] < 0.5:
                continue  # Pular faces com baixa confiança
...
if __name__ == "__main__":
    analyze_emotions_video()

# # Caminho para a pasta de imagens com rostos conhecidos
# image_folder = 'images'

# # Carregar imagens e codificações
# known_face_encodings, known_face_names = _load_images_from_folder(image_folder)
